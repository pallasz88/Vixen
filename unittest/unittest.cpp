...
BOOST_AUTO_TEST_CASE(Test_pawnmovement)
{
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList7{65266, 61170, 57074, 52978, 65461, 61365, 57269, 53173,
...
BOOST_AUTO_TEST_CASE(Test_knightmovement)
{
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList2{640,  1088, 839,  1415, 1057, 1185, 1761, 2785, 3105, 3233,
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList4{17024, 17472, 839,  1415, 1057, 1185, 1761, 2785, 3105, 3233,
                                        1382,  1510,  1830, 2854, 3430, 3558, 2680, 3256, 3007, 3455};
    BOOST_TEST(CheckMoveList(expectedMoveList4));
}
...
BOOST_AUTO_TEST_CASE(Test_bishopmovement)
{
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList{92, 476, 668, 924, 1244, 1372, 2268, 2396, 2716, 2972, 3164, 3548, 3612};
    BOOST_TEST(CheckMoveList(expectedMoveList));
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList3{92, 476, 668, 924, 1244, 1372, 2268, 2396, 2716, 2972, 3164, 3548, 3612};
    BOOST_TEST(CheckMoveList(expectedMoveList3));
...
BOOST_AUTO_TEST_CASE(Test_rookmovement)
{
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList{284,  796,  1308, 1564, 1628, 1692, 1756,
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList3{284,  796,  1308, 1564, 1628, 1692, 1756,
                                        1884, 1948, 2012, 2332, 2844, 3356, 3868};
    BOOST_TEST(CheckMoveList(expectedMoveList3));
...
BOOST_AUTO_TEST_CASE(Test_queenmovement)
{
    ...
    board.PrintBoard();
    std::vector<Move> expectedMoveList{92,  476,  668,  924,  1244, 1372, 2268, 2396, 2716, 2972, 3164, 3548, 3612, 284,
                                       796, 1308, 1564, 1628, 1692, 1756, 1884, 1948, 2012, 2332, 2844, 3356, 3868};
    BOOST_TEST(CheckMoveList(expectedMoveList));
