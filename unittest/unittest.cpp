...
*/
    BOOST_AUTO_TEST_CASE(Test_pawnmovement)
    {
        ...
        BOOST_TEST(board.GetAllMoves() == expectedMoveList, boost::test_tools::per_element());

        board.SetBoard("8/4p3/2npP3/3P4/8/8/8/8 w - - 0 1");
        board.PrintBoard();
        std::vector<Move> expectedMoveList2{19300};
        BOOST_TEST(board.GetAllMoves() == expectedMoveList2, boost::test_tools::per_element());

        board.SetBoard("8/8/8/8/2pP4/8/8/8 b - d3 0 1");
        board.PrintBoard();
        std::vector<Move> expectedMoveList3{21789, 1373};
        BOOST_TEST(board.GetAllMoves() == expectedMoveList3, boost::test_tools::per_element());

        board.SetBoard("8/8/8/7p/p6P/P6p/8/8 w - - 0 1");
        board.PrintBoard();
        std::vector<Move> expectedMoveList4;
        BOOST_TEST(board.GetAllMoves() == expectedMoveList4, boost::test_tools::per_element());

        board.SetBoard("8/8/8/7p/p6P/P6p/7P/8 b - - 0 1");
        board.PrintBoard();
        std::vector<Move> expectedMoveList5;
        BOOST_TEST(board.GetAllMoves() == expectedMoveList5, boost::test_tools::per_element());
        ...
        BOOST_TEST(board.GetAllMoves() == expectedMoveList6, boost::test_tools::per_element());
        ...
        BOOST_TEST(board.GetAllMoves() == expectedMoveList7, boost::test_tools::per_element());
    }
    ...
    BOOST_AUTO_TEST_CASE(Test_huge_amunt_of_moves)
    {
        ...
        board.PrintBoard();
        BOOST_TEST(board.GetAllMoves().size() == 218);
        ...
        board.PrintBoard();
        BOOST_TEST(board.GetAllMoves().size() == 48);
    }
